...
from cafuser.data.datasets import register_waymo_semantic  # noqa: F401

print("Waymo datasets after import:", [x for x in DatasetCatalog.list() if "waymo" in x])
if "waymo_semantic_train" in DatasetCatalog.list():
    print("Waymo metadata:", MetadataCatalog.get("waymo_semantic_train").as_dict())
